...
import { DecreaseQty, IncreaseQty, RemoveItems } from "../redux/CartSlice";
    ...
    return(
        <div className='w-full h-30 p-3 shadow-lg rounded-lg flex justify-between '>
            ...
            <div className='w-[60%] h-full  flex rounded gap-4'>
                ...
                <div className='w-[40%] h-full flex flex-col gap-2 justify-center items-center'>
                    ...
                    <div className='w-25 h-12 flex ustify-center items-center rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-blue-500'>
                        <button className='w-[30%] h-full bg-white flex justify-center items-center cursor-pointer' onClick={()=>{qty>1?dispatch(DecreaseQty({id:id})):1}}>-</button>
                        <span className='w-[40%] h-full bg-gray-300  flex justify-center items-center'>{qty}</span>
                        <button className='w-[30%] h-full bg-white flex justify-center items-center cursor-pointer' onClick={()=>dispatch(IncreaseQty({id:id}))}>+</button>
                    </div>
                </div>
            </div>
            ...
            <div className='flex flex-col justify-start items-end gap-4'>
                ...
                <RiDeleteBin6Line className='text-red-600 text-2xl cursor-pointer' onClick={()=>{dispatch(RemoveItems(id));toast.error("Item removed")}} />
